...
public class SharedPreferencesUtils {
     ...
     * @return
     */
    public static <T> T getValue(SharedPreferences sp, String key, Class<T> clazz) {
    ...
    public static  <T> T getObject(SharedPreferences sp,String key, Class<T> clazz) {
        if (sp.contains(key)) {
     ...
     */
    @SuppressWarnings("unchecked")
    static private <T> T getValue(String key, Class<T> clazz, SharedPreferences sp) {
        T t;
        try {
