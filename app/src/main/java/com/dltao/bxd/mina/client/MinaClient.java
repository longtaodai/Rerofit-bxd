package com.dltao.bxd.mina.client;
...
public class MinaClient {
        ...
        public void handleMessage(Message msg) {
            switch (msg.arg1) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    clientStateListener.messageReceived(msg.getData().getByteArray(MESSAGE));
                    break;
                case 5:
                    clientStateListener.messageSent(msg.getData().getByteArray(MESSAGE));
                    break;
                default:
                    break;
            }
    ...
    private class ConnectThread implements Runnable {
        ...
        public void run() {
            ...
            mConnection.getFilterChain().addLast("codec", new ProtocolCodecFilter(new
                    ObjectSerializationCodecFactory()));
            mConnection.getFilterChain().addLast("exceutor", new ExecutorFilter());
        ...
        public void sendMsg(byte[] message) {
            if (mSession != null && mSession.isConnected()) {
                mSession.write(IoBuffer.wrap(message));    // 发送消息 这里是发送字节数组的重点
            }
        }
